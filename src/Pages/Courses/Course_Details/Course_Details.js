            ...
            <div className=" rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100 ">
                ...
                <div className="flex flex-col justify-between p-6 space-y-8 pb-10">
                    ...
                    {/* <p className="dark:text-gray-100 px-36">{singelCourse.Paragrap}</p> */}
                        <Link to={'/login'}><button type="button" className=" flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md dark:bg-violet-500 hover:bg-violet-400 dark:text-gray-900">Continue Course</button></Link>
                </div>
            </div>
        </div>

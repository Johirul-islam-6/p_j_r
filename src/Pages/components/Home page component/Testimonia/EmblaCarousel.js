...
const EmblaCarousel = (props) => {
          ...
          <div className="embla__container">
            {slides.map((index) => ( <>
              {/* <div className="embla__slide" key={index}>
                ...
                <img
                  className="embla__slide__img bg-slate-500"
  ...
  <div className="md:flex flex-shrink-0 w-full mb-6 h-44 sm:h-16 sm:w-16 sm:mb-0 hidden ">
		<img src="https://source.unsplash.com/100x100/?portrait?1" alt="" className="object-cover object-center md:w-full md:h-full  rounded dark:bg-gray-500" />
	</div>
    ...
    <p className='roboto text-[17px]' >Lorem ipsum dolor, sit amet consectetur adipisicing elit. Aliquam perspiciatis vitae est dicta excepturi quam iure, molestiae explicabo odio iste. Lorem ipsum dolor sit amet consectetur, adipisicing elit. Maiores, labore!</p>

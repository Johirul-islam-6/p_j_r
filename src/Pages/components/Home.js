        ...
        <div>
            <section className="dark:bg-gray-800 dark:text-gray-100 lg:px-20 px-5">
                <div className="container flex flex-col justify-center p-6 mx-auto sm:py-12 lg:py-24 lg:flex-row lg:justify-between">
                    <div data-aos="fade-up-right" data-aos-easing="ease-out-cubic" data-aos-duration="1000" className="flex flex-col justify-center p-6 text-center rounded-sm lg:max-w-md xl:max-w-lg lg:text-left">
                    ...
                    <div data-aos="zoom-in" data-aos-easing="ease-out-cubic" data-aos-duration="900" className="flex items-center justify-center p-6 mt-8 lg:mt-0 h-69 sm:h-80 lg:h-96 xl:h-112 2xl:h-128">

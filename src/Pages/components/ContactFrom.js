            ...
            <div class="flex flex-wrap">
              ...
              <div
                ...
                <div class="align-start md:flex">
                  ...
                  <div class="ml-6 grow">
                    <p class="mb-2 font-bold dark:text-white">Support :</p>
                    <p class="text-neutral-500 dark:text-neutral-200">
                      johirkhan10@gmail.com
                    </p>
                    <p class="text-neutral-500 dark:text-neutral-200">

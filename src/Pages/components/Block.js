        ...
        <div>
            ...
            <div className="dark:bg-gray-800 dark:text-gray-100 mt-5">
                <div className="container max-w-4xl px-10 py-6 mx-auto rounded-lg shadow-sm dark:bg-gray-900">
                    ...
                    <div className="mt-3">
                        <a rel="noopener noreferrer" href="#" className="text-2xl font-bold hover:underline">01.Another Places authentication?</a>
            ...
            <div className="dark:bg-gray-800 dark:text-gray-100 mt-5">
                <div className="container max-w-4xl px-10 py-6 mx-auto rounded-lg shadow-sm dark:bg-gray-900">
                    ...
                    <div className="mt-3">
                        <a rel="noopener noreferrer" href="#" className="text-2xl font-bold hover:underline">01.How does work node js?</a>
            ...
            <div className="dark:bg-gray-800 dark:text-gray-100 mt-5">
                <div className="container max-w-4xl px-10 py-6 mx-auto rounded-lg shadow-sm dark:bg-gray-900">
                    ...
                    <div className="mt-3">
                        <a rel="noopener noreferrer" href="#" className="text-2xl font-bold hover:underline">01.How work Privet router in React.js</a>

    ...
    return (
        <div className='w-[100%] md:h-[110vh] pt-20 relative'>
            <div className="absolute top-10 right-5 z-50">
                <a a href='https://drive.google.com/file/d/1wXU0etOsXQbAAmNfxGilkz-7zZDgU22A/view?usp=share_link' className='absolute top-10 right-44 btn bg-amber-600 outline-none mt-2 text-white'>downlode</a>
            </div>
